...
scopus_path_csv_original = 'arquivos/scopus-original.csv'
scopus_path_csv = 'arquivos/scopus.csv'
scopus_path_txt = 'arquivos/scopus.txt'
wos_path_txt_original = 'arquivos/wos-original.txt'
wos_path_txt = 'arquivos/wos.txt'
wos_path_csv = 'arquivos/wos.csv'
all_in_one_csv = 'all_in_one.csv'
all_in_one_txt = 'all_in_one.txt'
